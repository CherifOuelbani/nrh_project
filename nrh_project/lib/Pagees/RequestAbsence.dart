                      ...
                      children: [
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text("Absence type",style: TextStyle(fontSize: 16),),
                              SizedBox(width: 60,),
                              TextButton(onPressed: (){_showOptions(context);}, child: Text(' $_selectedOption',selectionColor: Colors.black,style: TextStyle(fontSize: 16,color: Colors.black),)),
                         ...
                         Padding(
                           ...
                           child: Container(
                            height: 145,
                            width: 316,
                            decoration: BoxDecoration(borderRadius: BorderRadius.circular(18),border: Border.all(color: const Color.fromARGB(255, 188, 188, 188))),
                             child: Padding(
                               ...
                               child: Column(
                                 children: [
                                   Container(
                                    height: 49,
                                    width:366 ,
                                    decoration: BoxDecoration(borderRadius:  BorderRadius.only(topLeft :Radius.circular(21),topRight :Radius.circular(21)),color: const Color.fromRGBO(235, 230, 255, 1)),
                                    ...
                                    height: 49,
                                    width:366 ,
                                    decoration: BoxDecoration(borderRadius: BorderRadius.only(bottomLeft :Radius.circular(21),bottomRight :Radius.circular(21)),color: const Color.fromRGBO(235, 230, 255, 1)),
                                     child: MaterialButton(
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        height: 57,
                                          width: 364,
                                          decoration: BoxDecoration(borderRadius: BorderRadius.circular(8),color:Color.fromRGBO(235, 230, 255, 1) ,),
                                        child: MaterialButton(
