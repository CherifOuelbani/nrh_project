...
class _Absence_1State extends State<Absence_1> {
  ...
  Widget _buildAdditionalItem(BuildContext context, IconData icon, String itemName, Color color) {
    ...
    child: Column(
      ...
      children: <Widget>[
        ...
        SizedBox(height: 4),
        Text(itemName, style: TextStyle(color: Color.fromARGB(255, 87, 87, 87),),),
      ],
    ),
    );
    ...
    builder: (BuildContext context) {
      return Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            _buildAdditionalItem(context, Icons.settings, 'Settings',Color.fromARGB(255, 87, 87, 87),),
            _buildAdditionalItem(context, Icons.person, 'Personnes',Color.fromARGB(255, 87, 87, 87),),
          ],
        ),
      );
    },
                    ...
                    Row(
                      children: [
                        Padding(
                          ...
                          child: Column(
                            children: [
                              Text('21.0', style: TextStyle(fontSize: 24,color: Color.fromRGBO(113, 82, 243, 1)),),
                              Text('Cumulative days', style: TextStyle(fontSize: 15,color: Color.fromRGBO(113, 82, 243, 1)),)
                            ],
                          ),
                        ),
                        Padding(
                          ...
                          child: Column(
                            children: [
                              Text('21.0', style: TextStyle(fontSize: 24,color: Color.fromRGBO(113, 82, 243, 1)),),
                              Text(' Available days', style: TextStyle(fontSize: 15,color: Color.fromRGBO(113, 82, 243, 1)),)
                            ],
                          ),
                        ),
                        Padding(
                          ...
                          child: Column(
                            children: [
                              Text('21.0', style: TextStyle(fontSize: 24,color: Color.fromRGBO(113, 82, 243, 1)),),
                              Text(' Days used', style: TextStyle(fontSize: 15,color: Color.fromRGBO(113, 82, 243, 1)),)
                            ],
                          ),
                        )
                      ],
                      ...
                      child: Material(
                            elevation: 1,
                              ...
                              child: MaterialButton(
                                ...
                                minWidth: 364,
                                height: 57,
                                child: Text('Request Leave or Absence',
                                style: TextStyle(
                                  color:Colors.white,
                                  fontFamily: 'Lexend',
                                  fontSize:16,
